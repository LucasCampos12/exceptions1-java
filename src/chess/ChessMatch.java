...
//verifica se o oponente ficou em check		
		...
		// Jogada especial enPassan, verifica se o peao esta vulneravel
...
//verifica se a jogada eh possivel	
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		// Pega a posicao da peca promovida
...
//Metodo auxiliar para verificar qual peca foi escolhida para promocao	
...
//Metodo que move e remove peças caso necessario	
	private Piece makeMove(Position source, Position target) {
		...
		// movimento especial rock do rei
		...
		// movimento especial rock da rainha
		if (p instanceof King && target.getColumn() == source.getColumn() - 2) {
